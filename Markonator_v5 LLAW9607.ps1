...
function MJFWriteFeedback ( $currentRecord, $latePenalty, $latePenaltyString, $wcPenalty, $wcPenaltyString ) {
    ...
    $allFeedback = "<p><b>Criterion 1 (Issue 1)</b>                    : $c1</p>"
    $allFeedback = $allFeedback + "<p><b>Criterion 2 (Issue 2)</b>     : $c2</p>"
    $allFeedback = $allFeedback + "<p><b>Criterion 3 (AGLC)</b>        : $c3</p>"
    $allFeedback = $allFeedback + "<p><b>Criterion 4 (Readability)</b> : $c4</p>"
